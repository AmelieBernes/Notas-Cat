...
\definecolor{Ivory2}{HTML}{eceee4}
...
\newemptytheorem{defi}{Definición}
...
\begin{defi}
Un \textbf{\hlgray{bimorfismo}} es un morfismo que es epi y mono
(i.e. es cancelable por ambos lados).
\end{defi}
...
\begin{figure}[H]
\centering
	\includegraphics[scale=2.5]{cat8} 
 \end{figure}
...
En una categoría $\mathcal{A}$, un \textbf{\hlgray{igualador}}
